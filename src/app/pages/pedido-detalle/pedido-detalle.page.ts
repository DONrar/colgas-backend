...
import {
  ...
  checkmarkCircle, closeCircle, car, person, receiptOutline, calendarOutline, timeOutline, personOutline, personCircleOutline, callOutline, locationOutline, cartOutline, cubeOutline, cardOutline, logoWhatsapp, documentTextOutline } from 'ionicons/icons';
...
export class PedidoDetallePage implements OnInit {
 private route = inject(ActivatedRoute);
  ...
  constructor() {
    addIcons({arrowBack,receiptOutline,calendarOutline,timeOutline,personOutline,personCircleOutline,callOutline,locationOutline,cartOutline,cubeOutline,cardOutline,logoWhatsapp,documentTextOutline,cash,card,location,time,checkmarkCircle,closeCircle,car,person});
  }
